...
extern void (*set_texc_tristrip)( GLfloat *, GLfloat, GLfloat, GLfloat, GLfloat );
extern void (*set_texc_tri)( GLfloat *, GLfloat, GLfloat, GLfloat, GLfloat );
